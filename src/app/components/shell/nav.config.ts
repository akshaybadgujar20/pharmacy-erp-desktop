    ...
    items: [
      {
        ...
        subItems: [
          { icon: 'file', label: 'nav.sales.invoices', route: '/sales/invoices', permission: 'SALES:SALES_INVOICE:READ' },
    ...
    items: [
      {
        ...
        subItems: [
          { icon: 'medkit', label: 'nav.medicine.medicines', route: '/medicine/medicines', permission: 'MASTER:MEDICINE:READ' },
          { icon: 'tags', label: 'nav.medicine.categories', route: '/medicine/categories', permission: 'MASTER:MEDICINE_CATEGORY:READ' },
          { icon: 'list', label: 'nav.medicine.generics', route: '/medicine/generics', permission: 'MASTER:MEDICINE_GENERIC:READ' },
          { icon: 'calendar', label: 'nav.medicine.schedules', route: '/medicine/schedules', permission: 'MASTER:MEDICINE_SCHEDULE:READ' },
          { icon: 'industry', label: 'nav.medicine.manufacturers', route: '/medicine/manufacturers', permission: 'MASTER:MANUFACTURER:READ' },
          { icon: 'flask', label: 'nav.medicine.saltCompositions', route: '/medicine/salt-compositions', permission: 'MASTER:SALT_COMPOSITION:READ' },
          { icon: 'balance-scale', label: 'nav.medicine.units', route: '/medicine/units-of-measure', permission: 'MASTER:UNIT_OF_MEASURE:READ' },
        ],
      },
    ],
  },
