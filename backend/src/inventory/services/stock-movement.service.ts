...
import { toPartyContactResponse } from '../mappers/stock-take.mapper';
import {
  assertPartyExists,
  optimisticUpdate,
  throwConflict,
...
export class StockMovementService {
  ...
  async create(partyId: bigint, dto: CreateStockTransferDto) {
  ...
  async update(partyId: bigint, id: bigint, dto: UpdateStockTransferDto) {
    return this.unitOfWork.run(async (tx) => {
