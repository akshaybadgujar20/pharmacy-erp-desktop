...
import { toPartyAddressResponse } from '../mappers/stock-transfer.mapper';
import {
  assertPartyExists,
  optimisticUpdate,
  throwNotFound,
...
export class StockAdjustmentService {
  ...
  async create(partyId: bigint, dto: CreateStockAdjustmentItemDto) {
  ...
  async update(partyId: bigint, id: bigint, dto: UpdateStockAdjustmentItemDto) {
    return this.unitOfWork.run(async (tx) => {
